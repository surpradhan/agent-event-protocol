...
| **Python SDK** | `sdks/python/pyproject.toml` | latest on PyPI as [`agent-event-protocol`](https://pypi.org/project/agent-event-protocol/) (0.6.x at time of writing) | The active, carry-forward SDK — the registry is the authority; this cell is not updated per release. |
