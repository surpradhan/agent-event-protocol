...
- 24 unit tests for the OpenAI Agents trace/span→AEP mapping (runnable without the SDK installed) + 2 live-server integration tests (auto-skip when unreachable), matching 12b/12c/12d's coverage shape
- Docs: README + SDK README updated; CHANGELOG + PRD status flipped to ✅; memory index updated
